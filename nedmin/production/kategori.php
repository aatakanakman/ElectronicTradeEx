          ...
          <div class="x_content">
           ...
           <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th>Sıra No</th>
                <th width="40">Kategori Ad</th>
                <th>Kategori Sıra</th>
                <th>Kategori Seourl</th>
                <th width="40" >Kategori Durum</th>
                <th width="20" ></th>
                <th width="20" ></th>
              </tr>
            </thead>
            ...
            <tbody>
              ...
              while ($kategoricek=$kategorisor -> fetch(PDO::FETCH_ASSOC)) { $say++ ?>
                ...
                <tr>
                  ...
                  <td width="20"  ><?php echo $kategoricek['kategori_sira']; ?></td>
               ...
               <td><center><a href="../netting/islem.php?kategori_id=<?php echo $kategoricek['kategori_id'];?>&kategorisil=sil"><button class="btn btn-danger btn-xs" >Sil</button></a></center></td>   
             </tr>
