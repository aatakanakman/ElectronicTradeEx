              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <!-- Enctype methodu olmazsa resim karşı tarafa gitmez-->
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12"  enctype="multipart/form-data" for="first-name">Yüklü Logo<br><span class="required">*</span>
                  </label>
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" enctype="multipart/form-data" for="first-name">Resim Seç<span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="submit" name="logoduzenle" class="btn btn-primary">Resmi Güncelle</button>
                </div>
