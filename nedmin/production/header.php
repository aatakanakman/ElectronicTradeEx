      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>TOSBİG's</span></a>
          </div>
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-cogs"></i> Site Ayarları <span class="fa fa-cogs"></span></a>
                  <ul class="nav child_menu">
                    ...
                    <!--<li><a href="kullanici-duzenle.php">Kullanıcı Düzenle</a></li>-->
                ...
                <li><a href="urun.php"><i class="fa fa-barcode"></i> Ürünler </a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  ...
                  <span class=" fa fa-angle-down"></span><?php echo $kullanicicek['kullanici_adsoyad']; ?>
                </a>
