			...
			<div class="container">
				<div class="row">
					<div class="col-xs-6 col-md-4 main-logo">
						<a href="index.php" > <img src="<?php $ayarcek['ayar_logo'] ?>" alt="Site Logosu" class="logo img-responsive" enctype="multipart/form-data"></a>
					</div>
					<div class="col-md-8">
						<div class="pushright">
							<div class="top">
										...
										<div class="regwrap">
											<div class="row">
												...
												<div class="col-md-6">
													...
													<p>
														Hala kullanıcı girişi yapmadınız mı? Fırsatları yakalamak için acela etmelisin!
													</p>
